...
STARparameters = "".join(["--runThreadN",str(thread),"--sjdbOverhang","89","--sjdbGTFtagExonParentGene","gene_id","--outFilterMultimapNmax","1","--outSAMtype","BAM","SortedByCoordinate",
...
for i in range(len(fastqreads)):
    print fastqreads[i]
    print fastqreads[i][0],fastqreads[i][1]
